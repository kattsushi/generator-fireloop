...
module.exports = generators.Base.extend({
    prompting: function () {
        ...
        return this.prompt([{
            ...
            if (this.options.clients[answers.name]) {
                ...
                var clicmd = require.resolve('nativescript').replace(/nativescript\/lib\/nativescript-cli.js/, '') + ".bin/tns";
                this.spawnCommand(clicmd, ['create', answers.name, '--ng'], { shell: true })
    ...
    copyTemplates: function () {
        ...
        if (this.options.current) {
            [
                {
                    template: 'templates/ns.module.ts',
...
//# sourceMappingURL=/Volumes/HD710M/development/www/mean.expert/fireloop.io/generator-fireloop/src/nativescript/index.js.map